...
Open a token you launched and press **Manage**, or press **Manage** next
to it on the **Launches** tab of your portfolio. The page is gated by seat: it shows
...
**Hand over** - transfer your slot's share to another wallet
(`transferPayeeSlot`). The share is unchanged; only the recipient moves.

**Renounce fees** - give your share to the token's holders,
...
manage page shows any such balance as **You have fees waiting** and collects it
for you: one `setOperator` approval the first time, then a claim per
currency.

Waiting fees also show on your portfolio's Overview, in the **Claimable**
card, as *SYMBOL creator fees*. **Open** brings you to this page.
...
- **renounce the basket** - freeze it, forever (Base). On Robinhood
  Chain and Arc, hand the seat to a burn address instead.
...
When some of the vault has vested, your portfolio's **Claimable** card
shows *Release* with the amount, and **Open** brings you here.
