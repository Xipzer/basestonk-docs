...
Two different claims. Every active BaseStonk contract is verified and can
be read at its explorer - Basescan on Base, Blockscout on Robinhood Chain. "Unverified token" usually means only that
